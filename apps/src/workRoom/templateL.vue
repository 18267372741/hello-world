...
<script>
    ...
    export default {
        ...
        methods: {
        	...
        	photoTemps (id){//模板列表
				var url = this.host+'v1/work/temp/workTemp/'+this.id,
					postParam = {},
					self = this;
				postParam = {
					"tempTypeId":id,
			...
			dePhotoTemp (){//删除模板
				if(this.addr.groupid){
                    ...
                    var url = this.host+'v1/group/tempType?id='+this.photoTempId+'&workInfoId='+this.id;
                }
				var	postParam = {},
					self = this;
				Lib.M.load(url, postParam,function(data){
...
<style scoped>
    .mubanBox{
        overflow: hidden; padding: 0px 40px;height: 662px;
    }
    .mubans{
