	...
	<form class="login form-horizontal" id="businessManagementLogin">
		...
		<div class="form-group">
            <div class="col-sm-12">
                ...
                <a class="col-sm-offset-7" href="#/forget?type=work">找回密码</a>
            </div>
		</div>
	</form>
</template>
    ...
    export default {
        ...
        methods: {
            weixingLogin (){
                ...
                sessionStorage.setItem("position", "gongzuoshi");
                this.weixingLoginDE(this.addr.id,"WORK")
            },
            weixingLoginDE (id,type){
                ...
                Lib.M.load(url, postParam, function(data){
                    setTimeout(function(){
                        window.location.href='#/index/recOrder'; 
                    },1500)
                });
            },
            loginFn (){
                ...
                var url = this.host+'v1/work/Login',
                    postParam = {};
                postParam = {
...
<style scoped>
    .logins{
    	background: url(../assets/images/gongzuoshi.jpg) center center;height: 895px; 
    }
